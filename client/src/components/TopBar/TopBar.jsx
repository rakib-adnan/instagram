  ...
  return (
    ...
    <div className="main-bar-container">
        <div className="main-bar-wraper">
            <div className="logo"><img src="https://www.instagram.com/static/images/web/logged_out_wordmark.png/7a252de00b20.png" alt="" /></div>
            ...
            <div className="topbar-menu">
                <ul>
                    ...
                    <li><a href=""><img src={user.photo ? user.photo : 'https://img.freepik.com/premium-vector/young-man-avatar-cartoon-character-profile-picture_18591-55055.jpg?w=2000'} alt="" />
</a></li>
                </ul>
            </div>
        </div>
